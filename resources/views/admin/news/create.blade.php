...
@section('title', 'Criar Nova Notícia')
        ...
        <div class="card-body">
            <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4" id="publishedAtContainer" style="{{ old('status') != 'scheduled' ? 'display: none;' : '' }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Imagem principal que aparecerá como destaque (max. 2MB)</small>
                        @error('cover_image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Imagem adicional para o conteúdo (max. 2MB)</small>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="image-preview mb-3">
                                    <h6>Pré-visualização da Capa:</h6>
                            ...
                            <div class="col-md-6">
                                <div class="image-preview mb-3">
                                    <h6>Pré-visualização da Imagem Secundária:</h6>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-pipa-red">
                                <i class="bi bi-save me-2"></i> Salvar Notícia
                            </button>
                        </div>
                    </div>
                </div>
